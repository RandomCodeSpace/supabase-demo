                        ...
                        <AnimatePresence>
                            {features.map((feature, i) => (
                                <motion.div
                                    ...
                                    exit={{ opacity: 0, x: 20 }}
                                    className="bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-xl p-4 relative group"
                                >
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            ...
                                            className="opacity-0 group-hover:opacity-100 p-1.5 text-zen-text-muted hover:text-red-400 transition-all"
                                        >
                                            <Trash2 size={16} />
                                        </button>
                                    </div>
